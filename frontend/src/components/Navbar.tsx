				...
				<div className="flex items-center justify-between h-16">
					...
					<div className="hidden md:block">
						<div className="ml-10 flex items-baseline space-x-8">
							...
							<Link href="/ai-test" className="text-[#CBD5E1] hover:text-[#FF6B6B] px-3 py-2 text-sm font-medium transition-colors duration-200">
								AI Test
							</Link>
						</div>
					</div>
				...
				{isOpen && (
					<div className="md:hidden">
						<div className="px-2 pt-2 pb-3 space-y-1 border-t border-[#334155]">
							...
							<Link href="/ai-test" className="text-[#CBD5E1] hover:text-[#FF6B6B] block px-3 py-2 text-base font-medium transition-colors duration-200">
								AI Test
							</Link>
						</div>
					</div>
